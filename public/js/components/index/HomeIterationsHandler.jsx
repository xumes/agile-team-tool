...
module.exports.squadIterationsHandler = function(teamId, teamIterations, setSelectedIteration) {
  ...
  loadChartMultiChart('unitCostChart', 'Stories/Story Points per Person Day', 'line', graphCategory, 'Count', '', storyFTESeries, storyPointFTESeries, 'Points', setSelectedIteration);
