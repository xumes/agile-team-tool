...
var ComponentResultAndChart = React.createClass({
  ...
  loadDefaultChart: function(id, index) {
    ...
    this.displaySelectedChart(index, label, graphId, null);
  },

  displaySelectedChart: function(assessed_index, id, elementId, event) {
    var chartData = {};
    var title;
    var cat;
    var ave;
    if (id == 'Overall') {
      ave = this.getOverAllRawData(assessed_index);
...
module.exports = ComponentResultAndChart;
