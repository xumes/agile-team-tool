...
module.exports.hasIterations = (teamId) => {
...
module.exports.getByIterInfo = (teamId, limit) => {
  return new Promise(function(resolve, reject) {
    if (teamId) {
      Iteration.find({
        'teamId': teamId
...
module.exports.getCompletedIterationsByKey = (startkey, endkey) => {
  return new Promise(function(resolve, reject) {
    var qReq = {
      '$or': [
        {
...
module.exports.edit = (docId, data, user) => {
  return new Promise(function(resolve, reject) {
    // user validated through apikey works with users collection object, session ldap object if otherwise
    var userId = user.userId || user.ldap.uid;
 ...
 */
module.exports.getDefectsOpenBalance = (teamId, iterEndDate) => {
  return new Promise(function(resolve, reject) {
    var params = {
      id: teamId,
      endDate: iterEndDate,
...
module.exports.searchTeamIteration = (p) => {
  return new Promise(function(resolve, reject) {
    var qReq = {
      'docStatus': {
        '$ne': 'delete'
...
module.exports.calculateStatus = (data) => {
...
module.exports.calculateDefectEndngBalance = (data) => {
...
module.exports.bulkUpdateIterations = /* istanbul ignore next */ (Iterations) => {
  return new Promise(function(resolve, reject) {
...
module.exports.softDeleteArchive = (docId, user, status) => {
  return new Promise(function(resolve, reject) {
    var updateDoc = {};
...
// used in tests
module.exports.deleteIter = (docId, user) => {
  return new Promise(function(resolve, reject) {
...
module.exports.deleteByFields = /* istanbul ignore next */ (request) => {
  return new Promise(function(resolve, reject) {
    if (!request) {
...
module.exports.updateSprintAvailability = /* istanbul ignore next */ () => {
  var promiseArray = [];
